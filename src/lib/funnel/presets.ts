...
export const INDUSTRY_PRESETS: IndustryPreset[] = [
  ...
  },
  {
    ...
    social_platforms: [
      { platform: 'linkedin', posts_per_week: 3, content_types: ['articles', 'posts', 'case_studies'], funnel_entry_point: 'website_link' },
    ...
    close_mechanism: 'consultation',
    dormancy_threshold_days: 90,
    report_frequency: 'monthly',
    avg_deal_value_range: '₦500,000 – ₦10,000,000',
  },
  {
    id: 'agriculture',
    name: 'Agriculture & Agro-Allied',
    icon: '🌾',
    description: 'Farming, agro-processing, input supply, seasonal cycles',
    channels: ['facebook_ads', 'google_ads', 'whatsapp_broadcast'],
    social_platforms: [
      { platform: 'facebook', posts_per_week: 3, content_types: ['posts', 'videos', 'live'], funnel_entry_point: 'ctwa_button' },
      { platform: 'instagram', posts_per_week: 2, content_types: ['reels', 'carousel'], funnel_entry_point: 'link_in_bio' },
    ],
    nurture_length_days: 14,
    nurture_max_touchpoints: 5,
    close_mechanism: 'bank_transfer',
    dormancy_threshold_days: 90,
    report_frequency: 'monthly',
    avg_deal_value_range: '₦50,000 – ₦5,000,000',
  },
  {
    id: 'manufacturing',
    name: 'Manufacturing',
    icon: '🏭',
    description: 'Production, B2B supply, bulk orders, long procurement cycles',
    channels: ['google_ads', 'linkedin_ads', 'facebook_ads'],
    social_platforms: [
      { platform: 'linkedin', posts_per_week: 3, content_types: ['articles', 'posts', 'case_studies'], funnel_entry_point: 'website_link' },
      { platform: 'facebook', posts_per_week: 2, content_types: ['posts', 'videos'], funnel_entry_point: 'ctwa_button' },
    ],
    nurture_length_days: 30,
    nurture_max_touchpoints: 7,
    close_mechanism: 'bank_transfer',
    dormancy_threshold_days: 120,
    report_frequency: 'monthly',
    avg_deal_value_range: '₦500,000 – ₦50,000,000',
  },
  {
    id: 'hospitality',
    name: 'Hotels & Hospitality',
    icon: '🏨',
    description: 'Hotels, event centres, short-lets, seasonal bookings',
    channels: ['google_ads', 'instagram_ads', 'facebook_ads', 'google_maps'],
    social_platforms: [
      { platform: 'instagram', posts_per_week: 5, content_types: ['reels', 'stories', 'carousel'], funnel_entry_point: 'link_in_bio' },
      { platform: 'facebook', posts_per_week: 3, content_types: ['posts', 'videos', 'events'], funnel_entry_point: 'ctwa_button' },
      { platform: 'tiktok', posts_per_week: 2, content_types: ['short_video', 'room_tours'], funnel_entry_point: 'link_in_bio' },
    ],
    nurture_length_days: 7,
    nurture_max_touchpoints: 4,
    close_mechanism: 'hybrid',
    dormancy_threshold_days: 60,
    report_frequency: 'biweekly',
    avg_deal_value_range: '₦20,000 – ₦500,000',
  },
  {
    id: 'education',
    name: 'Education & Training',
    icon: '🎓',
    description: 'Schools, training centres, coaching — enrollment cycles',
