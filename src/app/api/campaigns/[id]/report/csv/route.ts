...
import { generateCampaignReport, formatReportAsCSV } from '@/lib/campaigns/report-generator'
  ...
  try {
    ...
    return new NextResponse(csv, {
      ...
      headers: {
        ...
        'Content-Disposition': `attachment; filename="campaign-${safeName}-report.csv"`,
      },
    })
  } catch (err: unknown) {
