...
//   on the list falls through to the default fallback with a
...
//
// Previous implementation hard-defaulted to the upstream URL
...
function getBaseUrl(request: Request): string {
  ...
  return process.env.NEXT_PUBLIC_APP_URL || "https://crm.marketing4effect.com";
}
