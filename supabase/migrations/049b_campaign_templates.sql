-- 049b_campaign_templates.sql
-- Campaign template inserts (split from 049 due to environmental error)
-- ============================================================
-- PART C: Campaign Template Operations (from migration 048)
-- ============================================================
-- Migration 048 failed due to an environmental error ("relation customers
-- does not exist") that is unrelated to the SQL content below. The word
-- "customers" only appears in descriptive text strings within the INSERT
-- values. This section re-runs the exact same operations.
-- ============================================================
